 ...
 * is delegated to a global exception handler (@ControllerAdvice).
 *
<<<<<<< Updated upstream
 * Note: Conventionally, this controller might be named AuthController
 * and mapped to a base path like "/auth".
 */
@RestController
@RequiredArgsConstructor // Lombok annotation for constructor injection of final fields
public class RegistryController { // Consider renaming to AuthController for clarity
=======
 */
@RestController
@RequestMapping("/registry") // Base URL for this controller
@RequiredArgsConstructor // Lombok annotation for constructor injection of final fields
...
<<<<<<< Updated upstream
    // The constructor is now generated by Lombok's @RequiredArgsConstructor
    // It will only inject the SecurityService.
=======
    // The constructor is generated by Lombok's @RequiredArgsConstructor
    // It will inject the SecurityService.
>>>>>>> Stashed changes
